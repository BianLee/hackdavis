      ...
      <main className="flex flex-col items-center justify-between p-2">
        <div className="container">
          <div className="text-5xl pb-7 font-semibold ">
            Yolo County Data Analysis
          </div>
          <br />
          <div className="text-lg">
            We wanted to answer the question: To what extent does Mental Health
            play a role in the Davis Community?
            <br />
            <br />
            We used Matplotlib and Jupyter Notebook to generate data
            visualizations to better understand this role.
          </div>
          <br />
          <h1>
            <a
              style={captionTitleStyle}
              href="https://github.com/ritvikir/hackdavis/blob/main/public/Narrative.pdf"
            >
              One Page Narrative
            </a>
          </h1>
          <h1>
            <a
              style={captionTitleStyle}
              href="https://github.com/ritvikir/hackdavis/blob/main/visualizationMentalHealth.ipynb"
            >
              Source Code
            </a>
          </h1>
  ...
  return (
    <div className="w-1/2 p-4 pb-4">
      ...
      {caption && (
        <p
          style={{ color: "#75e07e" }}
          className="text-center font-semibold pt-2 mb-5"
        >
          {caption}
        </p>
      )}
