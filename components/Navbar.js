...
export default function Navbar() {
  return (
    <nav className=" top-0 z-50 bg-white border-gray-200 px-2 sm:px-4 py-5">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <Link href="/" aria-current="page">
          <span className="flex items-center self-center text-2xl font-semibold whitespace-nowrap text-green-400">
            Esai
          </span>
        </Link>
        <button
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li className="block py-2 pr-4 pl-4 text-xl text-gray-700 hover:text-gray-50 md:hover:bg-transparent hover:text-gray-500">
              <Link href="/random">Feauture Y</Link>
            </li>
          </ul>
        </div>
      </div>
